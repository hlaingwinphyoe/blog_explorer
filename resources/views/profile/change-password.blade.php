        ...
        <div class="row justify-content-center min-vh-100">
            <div class="col-lg-6 col-xl-5">
                <div class="text-center mt-5">
                    ...
                    <img src="{{ asset(auth()->user()->photo) }}" class="border border-5 border-primary profile-img rounded-circle m-3" alt="">
                ...
                <form action="{{ route('update-password') }}" method="post">
                    ...
                    <div class="text-center">
                        <button class="btn btn-lg btn-primary"><i class="fa-solid fa-key"></i> Change Password</button>
                    </div>
                </form>
            </div>
        </div>
